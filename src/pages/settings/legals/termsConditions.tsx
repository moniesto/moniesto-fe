  ...
  return (
    ...
    >
      <Stack mt={2} p={3} spacing={4}>
        ...
        <div>
          <p>Welcome to Moniesto!</p>

          <p>
            These terms and conditions outline the rules and regulations for the
            use of Moniesto's Website, located at https://moniesto.com.
          </p>
          ...
          <p>
            ...
            subject to, prevailing law of tr. Any use of the above terminology
          ...
          <p>
            We employ the use of cookies. By accessing Moniesto, you agreed to
            use cookies in agreement with the Moniesto's Privacy Policy.{" "}
          </p>
          ...
          <p>
            Unless otherwise stated, Moniesto and/or its licensors own the
            intellectual property rights for all material on Moniesto. All
            intellectual property rights are reserved. You may access this from
            Moniesto for your own personal use subjected to restrictions set in
            these terms and conditions.
          </p>

          <p>You must not:</p>
          <ul>
            <li>Republish material from Moniesto</li>
            <li>Sell, rent or sub-license material from Moniesto</li>
            <li>Reproduce, duplicate or copy material from Moniesto</li>
            <li>Redistribute content from Moniesto</li>
          </ul>
          ...
          <p>
            ...
            Moniesto does not filter, edit, publish or review Comments prior to
            their presence on the website. Comments do not reflect the views and
            opinions of Moniesto,its agents and/or affiliates. Comments reflect
            the views and opinions of the person who post their views and
            opinions. To the extent permitted by applicable laws, Moniesto shall
          ...
          <p>
            Moniesto reserves the right to monitor all Comments and to remove
          ...
          <p>
            You hereby grant Moniesto a non-exclusive license to use, reproduce,
          ...
          <p>
            ...
            visibility of the hyperlink compensates the absence of Moniesto; and
          ...
          <p>
            ...
            sending an e-mail to Moniesto. Please include your name, your
          ...
          <p>
            No use of Moniesto's logo or other artwork will be allowed for
